...
public final class CreateOrUpdateRepositoryDto {

    private final String remoteId;
    private final String name;
    private final String fullName;

    public CreateOrUpdateRepositoryDto(final String remoteId, final String name, final String fullName) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof CreateOrUpdateRepositoryDto)) {
            return false;
        }
        final CreateOrUpdateRepositoryDto that = (CreateOrUpdateRepositoryDto) o;
